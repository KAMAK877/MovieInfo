...
const showMovieData = (data) => {
    ...
    const movieRuntimeElement = document.createElement('div')
    movieRuntimeElement.classList.add('runtime')
    movieRuntimeElement.innerHTML= `<h1>${Runtime}</h1>`
...
// console.log(searchButton);
>>>>>>> 4b4c98598eb1a397346322a98fa880281a6eb685
